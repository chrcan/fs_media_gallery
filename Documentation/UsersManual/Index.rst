...
#. Make sure the static template *Media Gallery (fs_media_gallery)* is included
   ...
   If you use `EXT:bootstrap_package <https://extensions.typo3.org/extension/bootstrap_package/>`_ include static template *Media Gallery Theme 'Bootstrap5' (fs_media_gallery)*.
